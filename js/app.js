 ...
 */
    ...
    (() => {
        ...
        let maskPhone = document.querySelectorAll(".form-phone");
        for (let i = 0; i < maskPhone.length; i++) {
            let im = new Inputmask("+7(999)-999-99-99");
            im.mask(maskPhone);
        }
        let pupupPhone = document.querySelector(".form-popup__phone");
        let phoneMass = new Inputmask("+7(999)-999-99-99");
        phoneMass.mask(pupupPhone);
        ...
        function initSliders() {
            ...
            if (document.querySelector(".slider")) new core(".slider", {
                ...
                loop: true,
                navigation: {
                    prevEl: ".korusel-button-prev",
                    nextEl: ".korusel-button-next"
                }
            });
            if (document.querySelector(".slider-box")) new core(".slider-box", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".belts")) new core(".belts", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".bottle")) new core(".bottle", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".flowers")) new core(".flowers", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".scroll")) new core(".scroll", {
...
***************************************************************************** */
        ...
        const vidget = document.querySelector(".vidjet-button");
        const social = document.querySelector(".vidjet__social");
        const showContent = document.getElementById("arrow");
        const script_images = document.querySelector(".vidjet__image");
        let wayImages = [ "img/vidjet/exit.svg", "img/vidjet/Frame1.svg" ];
        let theNum = [ 0 ];
        function myFun() {
            if (theNum === wayImages.length) theNum = "0";
            script_images.src = wayImages[theNum];
            theNum++;
        }
        vidget.addEventListener("click", (() => {
            social.classList.toggle("vidjet-active");
            myFun();
            script_images.classList.toggle("vidget-hover");
        }));
        if (showContent) showContent.addEventListener("click", (() => {
            showContent.classList.toggle("show-arrow");
        }));
        document.querySelectorAll(".menu__link");
        const navLink = window.location.pathname;
        console.log(navLink);
        if ("/gift.html" === navLink) {
            const gift = document.getElementById("gift");
            gift.style.color = "#BB7151";
        }
        if ("/products.html" === navLink) {
            const alko = document.getElementById("alko");
            alko.style.color = "#BB7151";
        }
        if ("/flowers.html" === navLink) {
            const flowers = document.getElementById("flowers");
            flowers.style.color = "#BB7151";
        }
        if ("/brend.html" === navLink) {
            const brend = document.getElementById("brend");
            brend.style.color = "#BB7151";
        }
        if ("/contact.html" === navLink) {
            const contact = document.getElementById("contact");
            contact.style.color = "#BB7151";
        }
        window["FLS"] = false;
        isWebp();
        menuInit();
